# Generated by Django 4.0.4 on 2022-11-28 18:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(null=True, upload_to='postVideos')),
            ],
        ),
        migrations.CreateModel(
            name='Story',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('storyMedia', models.ManyToManyField(to='api.media')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite', models.ManyToManyField(blank=True, related_name='postFavorite', to=settings.AUTH_USER_MODEL)),
                ('likes', models.ManyToManyField(blank=True, related_name='postLikes', to=settings.AUTH_USER_MODEL)),
                ('postMedia', models.ManyToManyField(to='api.media')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
