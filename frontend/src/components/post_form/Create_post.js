...
function Create_post() {
    ...
    const { user, setIsPostFormActive, handleClickSnackBar, setSnackBarMsg } = useContext(AppContext)
  ...
  return (
    <div className='clicked z-20 fixed top-0 left-0 right-0 bottom-0 w-full min-h-screen bg-[rgba(0,0,0,.65)] flex items-center justify-center'>
        ...
        <form className='mix-w-[348px] max-w-[855px] min-h-[391px] max-h-[898px] bg-white rounded' >
            ...
            <div className={`flex items-center justify-center mix-w-[348px] max-w-[855px] min-h-[391px] max-h-[898px]`}>
                {image == null? 
                    <FileUploader 
                ...
                {slider_counter === 1 &&
                    <div className={`w-[340px] h-[400px] bg-white overflow-x-hidden overflow-y-scroll`}>
                        <header className="flex gap-2 h-16 items-center px-[10px] py-[8px]">
                            <img src={"/media/"+user.profile} className="w-[40px] h-[40px] rounded-full object-cover" alt="" />
                        ...
                        {/* settings */}
                        <div className="w-full h-auto py-[7px] px-[10px]">
